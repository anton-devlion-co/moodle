...
class tool_customlang_external extends external_api {
    /**
    ...
    public static function translation_get_string($identifier) {
        ...
        return translation::get_string($params['identifier']);
    }
    /**
    ...
    public static function translation_update_string($string, $identifier) {
        ...
        return translation::update_string($params['identifier'], $params['string']);
    }
    /**
     * Returns description of method result value
     * @return external_description
