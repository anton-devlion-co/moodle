 ...
 *
 * Contains HTML class for a smartselect type element
 *
 * @package   core_form
...
require_once('HTML/QuickForm/smartselect.php');
require_once('templatable_form_element.php');

/**
 * smartselect type form element
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class MoodleQuickForm_smartselect extends HTML_QuickForm_smartselect implements templatable {
    ...
    public function __construct($elementName=null, $elementLabel=null, $options=null, $attributes=null) {
        ...
        // Importing select2 JS lib and select2 css
        global $PAGE;
     ...
     */
    public function MoodleQuickForm_smartselect($elementName=null, $elementLabel=null, $options=null, $attributes=null) {
