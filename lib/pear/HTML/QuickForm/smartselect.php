 ...
 * @access       public
 */
class HTML_QuickForm_smartselect extends HTML_QuickForm_element {
     ...
     */
    public function HTML_QuickForm_smartselect($elementName=null, $elementLabel=null, $options=null, $attributes=null) {
    ...
    function toHtml()
    {
        if ($this->_flagFrozen) {
            ...
            $strHtml .= $tabs . '<select' . $attrString . " class=\"smartselect2\">\n";
